 ...
 *
 * Foxtrick MV3 service worker entry point.
 * Replaces the background.html background page.
 *
 * @author Foxtrick contributors
 */

'use strict';

// Load all scripts that were previously in background.html
// using importScripts() which is synchronous and works in service workers
...
importScripts(
	...
	'./lib/psico.js',
	'./lib/gauge.js',
	'./lib/exceptionless.universal.js'
);
...
// categorized modules (only those needed in background)
importScripts(
...
// platform-specific (background entry)
importScripts(
	'./entry.js',
	'./background.js'
);
